            ...
            switch (inputArgs[0]) {
                ...
                case "cp" -> {
                    if (inputArgs.length == 5) {
                        ...
                        System.out.println("ERRO, TEMPLATE É: cp <NOME_PROF> <EMAIL_PROF> <SENHA_PROF> <MATRICULA_PROF>");
                    }
                }
                case "lu" -> {
                ...
                case "ca" -> {
                    if (inputArgs.length == 6) {
                        ...
                        try {
                            ...
                            service.cadastrarAvaliacao(estudante, inputArgs[1], turma, nota, inputArgs[4], LocalDate.now(), tag);
                        ...
                        System.out.println("ERRO, TEMPLATE É: ca <TITULO_DISC> <NOTA_DISC> <NUM_TURMA> <COMENTARIO> <TAG>");
                    }
                }
                default -> {
